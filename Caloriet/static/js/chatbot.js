...
const handleChat = () => {
    ...
    setTimeout(() => {
        // Send AJAX request to your Python backend
        fetch('/get_response', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            const responseMessage = data.response; // Modify this according to your response format
            const responseChatLi = createChatLi(responseMessage.replace(/[*|_-]/g, ''), "incoming");
        ...
        .catch(error => {
            ...
            errorMessageLi.classList.add("error");
